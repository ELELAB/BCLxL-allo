...
#creates reference
path_traj=../../../../../../../../../simulations/free/2lpc_1-169/replicate4/CHARMM22star_TIPS3P/md/Mol_An/center_traj.xtc
path_tpr=../../../../../../../../../simulations/free/2lpc_1-169/replicate4/CHARMM22star_TIPS3P/md/md.tpr


gmx trjconv -f ${path_traj} -s ${path_tpr} -n index -b 0 -e 0 -o reference.pdb << eof
19
eof
