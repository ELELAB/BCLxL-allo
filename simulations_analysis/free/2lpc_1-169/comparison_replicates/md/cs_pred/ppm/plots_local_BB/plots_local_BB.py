...
# data 
data2lpc = pd.read_csv('bclxl_free_2lpc_compilation_bb_red_chisq.csv',sep=';')
data2m03 = pd.read_csv('bclxl_free_2m03_compilation_bb_red_chisq.csv',sep=';')

# label names
columns = {'replicate1_c22star_tip3p': 'Rep 1 (CHARMM22* + TIP3P)',
           'replicate1_c22star_tips3p':'Rep 1 (CHARMM22* + TIP3SP)' ,
           'replicate2_c22star_tip3p': 'Rep 2 (CHARMM22* + TIP3P)',
           'replicate2_c22star_tips3p':'Rep 2 (CHARMM22* + TIPS3P)',
           'replicate3_c22star_tips3p':'Rep 3 (CHARMM22*) + TIP3P)',
           'replicate4_a99sbdisp':'Rep 4   (a99sb-disp)',
           'replicate4_c22star':'Rep 4 (CHARMM22* + TIPS3P)'}
...
plotter_chis_bb(data2m03,'2m03' )
plotter_chis_bb(data2lpc,'2lpc' )
