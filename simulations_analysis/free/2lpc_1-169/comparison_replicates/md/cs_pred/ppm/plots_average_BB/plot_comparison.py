...
cmap = ListedColormap(sns.color_palette("colorblind",11).as_hex())
...
for j in range(len(cs_datasets)):
    ...
    # paths
    replicate11 = '../../../../../replicate1/CHARMM22star_TIP3P/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
    replicate12 = '../../../../../replicate1/CHARMM22star_TIPS3P/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
    replicate21 = '../../../../../replicate2/CHARMM22star_TIP3P/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
    replicate22 = '../../../../../replicate2/CHARMM22star_TIPS3P/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
    replicate3 = '../../../../../replicate3/CHARMM22star_TIP3P/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
    replicate41 = '../../../../../replicate4/CHARMM22star_TIPS3P/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
    replicate42 = '../../../../../replicate4/a99SB-disp/md/cs_pred/ppm/ppm_exp_analysis/1000_ns_{}/csv_summary/output_chi_squared_BB.csv'.format(dataset)
