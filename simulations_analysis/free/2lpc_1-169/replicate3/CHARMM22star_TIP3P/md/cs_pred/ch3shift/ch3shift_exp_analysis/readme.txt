...
1. Create index file to eliminate capping groups from reference (NOTE: atoms correspoding to NH2 capping at C terminus unselected. See index.sh for selection)
>> sh index.sh
